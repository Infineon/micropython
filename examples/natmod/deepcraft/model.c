...
static uint32_t _K5_[144];
static uint32_t _K8_[16];
static uint32_t _K12_[1536];
static uint32_t _K14_[3072];
static uint32_t _K17_[32];
static uint32_t _K23_[6144];
static uint32_t _K25_[12288];
static uint32_t _K28_[64];
static uint32_t _K34_[384];
static uint32_t _K36_[6];

// Memory mapped buffers
#define _K12             ((float *)_K12_)                     // f32[32,3,16] (6144 bytes) 
#define _K14             ((float *)_K14_)                     // f32[32,3,32] (12288 bytes) 
#define _K17             ((float *)_K17_)                     // f32[32] (128 bytes) 
#define _K23             ((float *)_K23_)                     // f32[64,3,32] (24576 bytes) 
#define _K25             ((float *)_K25_)                     // f32[64,3,64] (49152 bytes) 
#define _K28             ((float *)_K28_)                     // f32[64] (256 bytes) 
#define _K34             ((float *)_K34_)                     // f32[6,64] (1536 bytes) 
#define _K36             ((float *)_K36_)                     // f32[6] (24 bytes) 
#define _K5              ((float *)_K5_)                      // f32[16,3,3] (576 bytes) 
#define _K8              ((float *)_K8_)                      // f32[16] (64 bytes)
...
memcpy(_K5_,_K5__,sizeof(_K5__));
...
memcpy(_K5_,_K5__,sizeof(_K5__));
memcpy(_K8_,_K8__,sizeof(_K8__));
memcpy(_K36_,_K36__,sizeof(_K36__));
memcpy(_K34_,_K34__,sizeof(_K34__));
memcpy(_K28_,_K28__,sizeof(_K28__));
memcpy(_K23_,_K23__,sizeof(_K23__));
memcpy(_K17_,_K17__,sizeof(_K17__));
memcpy(_K14_,_K14__,sizeof(_K14__));
memcpy(_K12_,_K12__,sizeof(_K12__));
memcpy(_K25_,_K25__,sizeof(_K25__));
